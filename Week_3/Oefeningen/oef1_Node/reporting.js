...
function showImportanceCount(data, highImportanceCount, lowImportanceCount) {
    ...
    console.log(
        `High Importance Percentage: ${
            (highImportanceCount / data.length) * 100
        }%`
    );
    console.log(
        `Low Importance Percentage: ${
            (lowImportanceCount / data.length) * 100
        }%`
    );
}

function showComplexityCount(data, highComplexityCount, lowComplexityCount) {
    ...
    console.log(
        `High Complexity Percentage: ${
            (highComplexityCount / data.length) * 100
        }%`
    );
    console.log(
        `Low Complexity Percentage: ${
            (lowComplexityCount / data.length) * 100
        }%`
    );
}
